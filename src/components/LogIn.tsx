        ...
        <section className="flex items-center justify-center pt-10 pb-10">
          <main className="flex flex-col w-5/12 py-10 pb-20 bg-black rounded-md gap-y-4 px-14 bg-opacity-70">
            ...
            <div className="flex flex-col items-center justify-center w-full gap-y-4">
              <input type="text" className="w-full px-4 py-4 bg-opacity-75 border-2 border-gray-400 rounded-md placeholder:text-gray-400 bg-neutral-900" placeholder="Email or phone number" />
              <input type="text" className="w-full px-4 py-4 bg-opacity-75 border-2 border-gray-400 rounded-md placeholder:text-gray-400 bg-neutral-900" placeholder="Password" />
