    ...
    <div className='w-full h-screen'>
      ...
      >
        ...
        >
          ...
          <div id="slide1" className='w-5/12 pt-52'>
          ...
          <div id="slide2" className='flex flex-col w-5/12 pt-36 gap-y-3'>
          ...
          <div id="slide3" className='flex flex-col w-5/12 pt-44 gap-y-3'>
            <button className='px-3 py-2 text-base font-semibold bg-black rounded-full w-fit bg-opacity-45'>🔥 Trending now</button>
